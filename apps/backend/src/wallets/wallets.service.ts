...
export class WalletsService {
  ...
  async listAdmin(params: { q?: string; page?: number; limit?: number }) {
    ...
    // Этот раздел про пользователей: кошельки компаний живут в /admin/billing.
  ...
  private async listTransactions(walletId: string, query: PaginationQueryDto) {
